package team.idivision.samples.designpatterns.behavioral.observer

import team.idivision.samples.designpatterns.Pattern
import team.idivision.samples.designpatterns.behavioral.observer.displays.CurrentConditionsDisplay
import team.idivision.samples.designpatterns.behavioral.observer.displays.ForecastDisplay
import team.idivision.samples.designpatterns.behavioral.observer.station.WeatherStation
...
class Observer : Pattern("Observer") {
    override fun launch() {
        val currentTemperature = 10.0f
        val currentHumidity = 20.0f
