package team.idivision.samples.designpatterns.patterns.behavioral.chain_of_responsibility.dispenser
...
class TwentyBillDispenser : DispenseChain {
    ...
    companion object {
        private const val DISPENSE_AMOUNT = 20
    }
}