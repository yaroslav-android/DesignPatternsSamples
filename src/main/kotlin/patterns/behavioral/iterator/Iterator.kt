package team.idivision.samples.designpatterns.patterns.behavioral.iterator

import team.idivision.samples.designpatterns.patterns.Pattern
import team.idivision.samples.designpatterns.patterns.behavioral.iterator.implementation.CustomList
...
class Iterator : Pattern("Iterator") {
    ...
    override fun launch() {
        val list: CustomList<Int> = CustomList<Int>()
            .apply { addAll(listOf(1, 2, 3, 4)) }
