package team.idivision.samples.designpatterns.patterns.structural.adapter

import team.idivision.samples.designpatterns.patterns.Pattern
import team.idivision.samples.designpatterns.patterns.structural.adapter.adapter.SquarePegAdapter
...
import team.idivision.samples.designpatterns.patterns.structural.adapter.shape.RoundHole
...
class Adapter : Pattern("Adapter") {
    ...
    override fun launch() {
        ...
        println("Can fit $smallPeg => ${roundHole.fits(pegAdapter.getRoundPeg())}")
    }
}