package team.idivision.samples.designpatterns.patterns.structural.composite

import team.idivision.samples.designpatterns.patterns.Pattern
import team.idivision.samples.designpatterns.patterns.structural.composite.pc.*
...
class Composite : Pattern("Composite") {
    ...
    override fun launch() {
        ...
        pc.getIterable().forEach { equipment ->
